    ...
    <div className="sa-profile">
      ...
      <div className="sa-profile__grid">
        ...
        <div className="sa-profile__section">
          ...
          <InfoRow label="Inscription" value={fmtDateTime(inst.createdAt)} />
          <InfoRow label="Mise à jour"  value={fmtDateTime(inst.updatedAt)} />
        </div>
                  ...
                  return (
                    <>
                      ...
                      >
                        ...
                        {/* Date */}
                        <td className="sa-cell sa-cell--date sa-col-date" data-label="Inscription">{fmtDateTime(inst.createdAt)}</td>
