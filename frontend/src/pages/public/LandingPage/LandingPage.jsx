...
const FEATURES_ROW1 = [
  ...
  { icon: '📱', color: '#eff6ff', iconColor: '#1E2A78', title: 'WhatsApp & Email', desc: 'Parents informés instantanément par WhatsApp. Distribution automatique dès la publication.' },
];
const FEATURES_ROW2 = [
...
const TESTIMONIALS = [
  ...
  { name: 'Prof. Edem Kodjo', role: 'Enseignant de Mathématiques', school: 'Lycée Technique de Kara', text: 'Je saisie mes notes depuis mon téléphone entre deux cours. C\'est rapide, intuitif. La signature numérique des fiches est une fonctionnalité que j\'adore. Je ne reviendrai jamais à Excel.', initials: 'EK', color: '#1E2A78', photo: 'https://i.pravatar.cc/100?img=12' },
  { name: 'Sena Fiatowo', role: 'Parent d\'élève', school: 'Lomé, Togo', text: 'Recevoir le bulletin de ma fille sur WhatsApp le jour même, c\'est fantastique ! Je peux suivre sa progression en temps réel depuis mon téléphone. Merci NovaBulletin.', initials: 'SF', color: '#FF7A59', photo: 'https://i.pravatar.cc/100?img=44' },
...
const DATABASE_MODULES = [
  ...
  { icon: '🏥', color: '#eff6ff', iconColor: '#1E2A78', title: 'Infirmerie & Santé', desc: 'Registre des visites, accidents, vaccinations et évacuations — avec compte rendu médical.' },
  ...
  { icon: '🎓', color: '#fff3f0', iconColor: '#FF7A59', title: 'Examens nationaux', desc: 'Résultats CEPD, BEPC, BAC, BTS, CAP. Taux de réussite par session, série, année.' },
  ...
  { icon: '📅', color: '#eff6ff', iconColor: '#1E2A78', title: 'Calendrier scolaire', desc: 'Vacances, examens, réunions, événements sportifs et culturels. Vue partagée.' },
...
const TEAM = [
  ...
  { name: 'Benjamin Ngbabou', role: 'Software Developer', tags: ['Marketing', 'Professeur de Mathématiques'], initials: 'BN', color: '#FF7A59', colorEnd: '#1E2A78', photo: '/team/benjamin.jpg', email: 'bawiloussimngbabou1@gmail.com' },
];
...
const FEATURES_ROW1_EN = [
  ...
  { icon: '📱', color: '#eff6ff', iconColor: '#1E2A78', title: 'WhatsApp & Email', desc: 'Parents notified instantly via WhatsApp. Automatic distribution as soon as published.' },
];
...
const DATABASE_MODULES_EN = [
  ...
  { icon: '🏥', color: '#eff6ff', iconColor: '#1E2A78', title: 'Health & Infirmary', desc: 'Register of visits, accidents, vaccinations and evacuations — with medical reports.' },
  ...
  { icon: '🎓', color: '#fff3f0', iconColor: '#FF7A59', title: 'National Exams', desc: 'CEPD, BEPC, BAC, BTS, CAP results. Pass rates by session, stream, year.' },
  ...
  { icon: '📅', color: '#eff6ff', iconColor: '#1E2A78', title: 'School Calendar', desc: 'Holidays, exams, meetings, sports and cultural events. Shared view.' },
